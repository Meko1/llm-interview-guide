...
- [垂直领域专家模型实战](https://meko1.github.io/llm-interview-guide/finetuning/domain-expert-model)（CPT/SFT 决策 / 灾难性遗忘 / 医疗金融法律案例）
...
- [大模型商业落地与价值评估](https://meko1.github.io/llm-interview-guide/engineering/llm-business)（场景筛选 / ROI / 业务翻译 / 失败模式）
...
- [机制可解释性（SAE/Circuits）](https://meko1.github.io/llm-interview-guide/advanced/interpretability)（叠加 / 稀疏自编码器 / 回路 / 特征操控）
