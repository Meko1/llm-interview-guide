...
> 安全是大模型落地的红线，也是越来越高频的面试方向。本文梳理越狱、Prompt 注入、红队、护栏与价值对齐等核心考点。要把这些防护进一步落到企业资产、策略执行、供应链和审计账本，可继续看 [企业 AI 安全、合规与审计控制面系统设计面试题](/interview/enterprise-ai-governance-audit-system-design)。
