    ...
    nav: [
      ...
      { text: 'RAG', link: '/rag/rag-basics', activeMatch: '/rag/' },
      {
        ...
        items: [
          ...
          { text: 'AI 工作流工程化', link: '/agent/workflow-engineering' },
          { text: 'Dify 与 Coze 工作流生产化', link: '/agent/dify-coze-workflow-production' },
          { text: 'n8n AI 工作流生产化', link: '/agent/n8n-ai-workflow-production' },
          { text: '耐久化 Agent 工作流', link: '/agent/durable-agent-workflows' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'FP&A / 财务经营分析 Copilot 生产系统设计', link: '/interview/fpa-financial-planning-analysis-copilot-playbook' },
          ...
          { text: 'Dify、Coze、n8n 与耐久工作流面试题', link: '/interview/agent-workflow-platform-qna' },
          ...
          { text: '用户记忆与个性化控制面', link: '/interview/llm-user-memory-personalization-control-plane' },
